# :running:android驿站-CoordinatorLayout:running:
...
- [CoordinatorBehaviorExample](#CoordinatorBehaviorExample)★2605 - 仿Hangouts4简介动画 :four_leaf_clover: 
- [android-ConstraintLayoutExamples](#android-ConstraintLayoutExamples)★2213 - 展示ContraintLayout的特性和使用 :four_leaf_clover: 
- [CoordinatorExamples](#CoordinatorExamples) ★1157 - 演示CoordinatorLayout的示例项目 :four_leaf_clover: 
- [TabbedCoordinatorLayout](#TabbedCoordinatorLayout)★755 - 演示CoordinatorLayout的示例项目 :four_leaf_clover: 
- [CoordinatorLayoutDemo](#CoordinatorLayoutDemo)★498 - 使用CoordinatorLayout仿稀土掘金个人界面 :four_leaf_clover: 


## CoordinatorBehaviorExample
[:point_right: :globe_with_meridians: :point_left:](https://github.com/saulmm/CoordinatorBehaviorExample) 
>_效果图如下：_

<img src="https://github.com/saulmm/CoordinatorBehaviorExample/blob/master/art/hammerheadLMY48Isaulmm08162015053205.gif" width="200">

<HR style="FILTER: progid:DXImageTransform.Microsoft.Shadow(color:#987cb9,direction:145,strength:15)" width="100%" color=#987cb9 SIZE=1>
  
## android-ConstraintLayoutExamples
[:point_right: :globe_with_meridians: :point_left:](https://github.com/googlesamples/android-ConstraintLayoutExamples) 
>_效果图如下：_
...
## CoordinatorExamples
[:point_right: :globe_with_meridians: :point_left:](https://github.com/saulmm/CoordinatorExamples)
>_效果图如下：_

<img src="https://github.com/saulmm/CoordinatorExamples/blob/master/art/example.gif" width="200">

<HR style="FILTER: progid:DXImageTransform.Microsoft.Shadow(color:#987cb9,direction:145,strength:15)" width="100%" color=#987cb9 SIZE=1>
  
## TabbedCoordinatorLayout
[:point_right: :globe_with_meridians: :point_left:](https://github.com/vitovalov/TabbedCoordinatorLayout) 
>_效果图如下：_

<img src="https://github.com/vitovalov/TabbedCoordinatorLayout/blob/master/art/demo.gif" width="200">

<HR style="FILTER: progid:DXImageTransform.Microsoft.Shadow(color:#987cb9,direction:145,strength:15)" width="100%" color=#987cb9 SIZE=1>
  
## CoordinatorLayoutDemo
[:point_right: :globe_with_meridians: :point_left:](https://github.com/loonggg/CoordinatorLayoutDemo) 
>_效果图如下：_

<img src="https://github.com/loonggg/CoordinatorLayoutDemo/blob/master/image/1.gif" width="200"><img src="https://github.com/loonggg/CoordinatorLayoutDemo/blob/master/image/cld.gif" width="200">
